...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-11 px-4 py-2 min-h-[48px] text-readable-sm",
        sm: "h-10 rounded-md px-3 min-h-[44px] text-readable-xs",
        lg: "h-12 rounded-lg px-8 min-h-[48px] text-readable-base",
        icon: "h-11 w-11 min-h-[48px] min-w-[48px]",
        xl: "h-14 rounded-lg px-10 min-h-[52px] text-readable-lg",
      },
    },
    defaultVariants: {
      variant: "default",
