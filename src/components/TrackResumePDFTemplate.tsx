    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginTop: 'auto', paddingTop: 20, borderTop: '1px solid #E5E7EB' }}>
          <Text style={styles.itemMeta}>
            Generated by Life Path AI • Track-Focused Resume • {new Date().toLocaleDateString()}
          </Text>
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginTop: 'auto', paddingTop: 20, borderTop: '1px solid #E5E7EB' }}>
          <Text style={styles.itemMeta}>
            Generated by Life Path AI • Multi-Track Professional Resume • {new Date().toLocaleDateString()}
          </Text>
        </View>
      </Page>
    </Document>
