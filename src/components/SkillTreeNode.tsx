...
export const SkillTreeNode: React.FC<SkillTreeNodeProps> = memo(({
  ...
  return (
    <div
      className={`absolute bg-white border-2 shadow-lg rounded-lg p-3 text-xs transition-all duration-200 cursor-pointer hover:shadow-xl soft-hover touch-manipulation ${statusRing} ${pathHighlight} ${goalHighlight} ${checkpointHighlight}`}
      style={{
        left: position.x,
        top: position.y,
