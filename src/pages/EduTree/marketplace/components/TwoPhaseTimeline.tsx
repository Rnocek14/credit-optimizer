...
export function TwoPhaseTimeline({ 
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className={cn("cursor-help", className)}>
              ...
              {/* Visual timeline bar */}
              <div className="flex h-1.5 rounded-full overflow-hidden bg-muted/30 dark:bg-white/5 mt-1">
                <div 
                  className="bg-muted-foreground/40 dark:bg-white/30 transition-all"
  ...
  return (
    <div className={cn("space-y-3", className)}>
      ...
      {/* Visual timeline bar */}
      <div className="flex h-3 rounded-full overflow-hidden bg-muted/30 dark:bg-white/5">
        <div 
          className="bg-muted-foreground/40 dark:bg-white/30 transition-all flex items-center justify-center"
          style={{ width: `${altProportion * 100}%` }}
        >
          {altProportion > 0.15 && (
            <span className="text-[9px] font-medium text-foreground dark:text-white">Prep</span>
          )}
        </div>
        <div 
