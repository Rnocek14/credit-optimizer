...
export const GOLDEN_LAYOUT_SEED: {
  ...
  blocks: [
    ...
    },
    {
      ...
      credits_needed: 6,
      position_x: getTrackColumnX(LAYOUT_CONSTANTS.YEAR_COLUMNS.Y3, 'se'),
      position_y: LAYOUT_CONSTANTS.LANE_ROWS.UP_TRACK_A_ELEC
    },
    ...
    },
    {
      ...
      credits_needed: 6,
      position_x: getTrackColumnX(LAYOUT_CONSTANTS.YEAR_COLUMNS.Y3, 'ds'),
      position_y: LAYOUT_CONSTANTS.LANE_ROWS.UP_TRACK_B_ELEC
    },
    ...
    },
    {
      ...
      position_y: LAYOUT_CONSTANTS.LANE_ROWS.UP_CAPSTONE_2
    },
    {
      id: "y4-it-cap",
      program_id: "bs_it",
...
export function filterBlocksByMode(
  ...
  // Sample verbose logs (2% in dev to reduce noise)
  const devSample = import.meta.env.DEV && Math.random() < 0.02;
  ...
  switch (filterMode) {
    case 'compare-programs':
      ...
      // Only log IT block tracing when sampled
      if (devSample) {
