  ...
  return (
    <div className="relative" ref={nodeRef}>
      ...
      <Card className={`
        ...
        ${isDegreeNode && isDegreeComplete ? 'border-accent-gold bg-gradient-to-br from-accent-gold/20 to-accent-gold/10 ring-2 ring-accent-gold/50 shadow-xl shadow-accent-gold/20' : 
        ...
        ${isDegreeNode && isDegreeComplete ? 'hover:shadow-2xl hover:shadow-accent-gold/30' : ''}
      `}>
