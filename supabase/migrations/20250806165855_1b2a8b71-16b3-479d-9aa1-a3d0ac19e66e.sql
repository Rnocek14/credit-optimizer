-- Remove foreign key constraint and add test data (final corrected version)
...
-- Insert mentor course feedback with correct column structure
INSERT INTO public.mentor_course_feedback (id, mentor_id, course_id, student_id, rating, course_quality_rating, learning_outcome_rating, feedback_text, would_recommend, completed_course, created_at)
VALUES 
  ('ffffffff-ffff-ffff-ffff-ffffffffffff', '2b458624-d498-4cca-a63d-9341cc20e363', '11111111-1111-1111-1111-111111111111', '3c459625-e499-5ddb-b64d-a442dd21f474', 5, 5, 5, 'Excellent course selection! Really helped with my career transition.', true, true, now() - interval '6 days'),
  ('gggggggg-gggg-gggg-gggg-gggggggggggg', '2b458624-d498-4cca-a63d-9341cc20e363', '22222222-2222-2222-2222-222222222222', '4d56a736-f5aa-6eec-c75e-b553ee32e585', 4, 4, 5, 'Great course recommendation, very relevant to current job market.', true, true, now() - interval '3 days'),
  ('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '2b458624-d498-4cca-a63d-9341cc20e363', '11111111-1111-1111-1111-111111111111', '3c459625-e499-5ddb-b64d-a442dd21f474', 5, 5, 4, 'Perfect match for my skill gaps, thank you!', true, false, now() - interval '1 day')
ON CONFLICT (id) DO NOTHING;