-- Create test data with simple inserts
...
-- Create test data using a more straightforward approach
DO $$
DECLARE
...
BEGIN
    ...
    VALUES 
      (course1_id, 'https://coursera.org/test-course-1', 'coursera', '{"title": "Advanced JavaScript", "description": "Learn advanced JS concepts"}', 'completed', now() - interval '10 days'),
      (course2_id, 'https://coursera.org/test-course-2', 'coursera', '{"title": "React Fundamentals", "description": "Master React development"}', 'completed', now() - interval '8 days'),
      (course3_id, 'https://coursera.org/test-course-3', 'coursera', '{"title": "Node.js Backend", "description": "Backend development with Node"}', 'completed', now() - interval '5 days');
