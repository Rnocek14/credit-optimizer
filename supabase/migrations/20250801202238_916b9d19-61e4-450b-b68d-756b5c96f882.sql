...
INSERT INTO user_preferences (user_id, experience_level, has_completed_onboarding)
VALUES ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 'intermediate', true)
ON CONFLICT (user_id) DO UPDATE SET experience_level = 'intermediate';

-- Create test goals for user
INSERT INTO user_goals (user_id, goal_title, goal_type)
VALUES
  ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 'Become a Data Analyst', 'career'),
  ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 'Complete SQL Course', 'learning');