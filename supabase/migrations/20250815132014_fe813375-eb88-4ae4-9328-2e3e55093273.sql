-- CRITICAL: Demo Data Seeding for Life Path Platform (Fixed array format)
...
('2b458624-d498-4cca-a63d-9341cc20e363', 'intermediate', true, ARRAY['unified_dashboard', 'ai_recommendations'], NOW()),
('3c459625-e499-5ddb-b64d-a442dd21f474', 'beginner', true, ARRAY['skill_tree', 'course_recommendations'], NOW()),
('4d56a736-f5aa-6eec-c75e-b553ee32e585', 'advanced', true, ARRAY['market_intelligence', 'workflow_automation'], NOW())
ON CONFLICT (user_id) DO UPDATE SET
...
('2b458624-d498-4cca-a63d-9341cc20e363', 'Become a Data Scientist', 'Transition from business analyst to data scientist with focus on machine learning', 'Senior Data Scientist', 24, true, ARRAY['Python', 'Machine Learning', 'Statistics'], NOW()),
('3c459625-e499-5ddb-b64d-a442dd21f474', 'Full Stack Developer', 'Learn complete web development stack to become a full stack developer', 'Full Stack Developer', 18, true, ARRAY['React', 'Node.js', 'Database Design'], NOW()),
('4d56a736-f5aa-6eec-c75e-b553ee32e585', 'UX Design Lead', 'Advance from UX designer to lead role with team management skills', 'UX Design Lead', 12, true, ARRAY['Leadership', 'Design Systems', 'User Research'], NOW())
