-- Fix demo users setup for gallery display
-- Remove broken migration and properly set up demo data

-- 1. Update Aisha Khan's existing profile
...
-- 2. Insert Mateo Silva profile (delete if exists first)
DELETE FROM public.profiles WHERE user_id = '3c459625-e499-5ddb-b64d-a442dd21f474'::uuid;
...
-- 3. Insert Jade Chen profile (delete if exists first)
DELETE FROM public.profiles WHERE user_id = '4d56a736-f5aa-6eec-c75e-b553ee32e585'::uuid;
INSERT INTO public.profiles (
  user_id, name, role_title, location, industry, years_experience, experience_level,
  skills, gallery_enabled, gallery_featured,
  resume_review_summary, created_at, updated_at
...
-- 4. Delete existing resume drafts and create new ones
...
-- 5. Ensure demo users have XP data
