-- Create additional Maya decisions with correct column names (decision_context not context_data)
INSERT INTO public.maya_decisions (user_id, decision_type, confidence_score, decision_context)
VALUES 
