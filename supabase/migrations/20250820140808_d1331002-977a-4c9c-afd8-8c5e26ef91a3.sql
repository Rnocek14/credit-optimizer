...
-- Create switching_scenarios table for saved scenarios
CREATE TABLE public.switching_scenarios (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
('UK-LON', 'Software Engineer', 45000, 65000, 90000, 1.1),
('UK-LON', 'Data Scientist', 50000, 75000, 100000, 1.2);
