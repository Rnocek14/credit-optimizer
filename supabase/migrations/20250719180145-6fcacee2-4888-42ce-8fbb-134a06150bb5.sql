...
-- Award some badges to make profiles more interesting
WITH badge_data AS (
  SELECT id, slug FROM public.badges WHERE slug IN ('first-steps', 'goal-setter', 'resume-publisher', 'high-achiever')
)
