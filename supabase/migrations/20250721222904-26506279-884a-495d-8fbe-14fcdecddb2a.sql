-- Seed user_skill_progress for demo users (corrected)
-- Valid status values: 'locked', 'in_progress', 'verified'

-- Seed user_skill_progress for Aisha Khan (UX Designer)
INSERT INTO user_skill_progress (user_id, skill_id, status, xp_earned, cri_score, verification_source) VALUES
-- Completed skills (5) - using 'verified' status
...
INSERT INTO user_skill_progress (user_id, skill_id, status, xp_earned, cri_score, verification_source) VALUES
-- Completed skills (7) - using 'verified' status
...
INSERT INTO user_skill_progress (user_id, skill_id, status, xp_earned, cri_score, verification_source) VALUES
-- Completed skills (4) - using 'verified' status
