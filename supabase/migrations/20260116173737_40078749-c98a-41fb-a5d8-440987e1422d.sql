...
-- Fix admin_list_latest_invariant_snapshots for deterministic pagination
-- Add template_id to ORDER BY so pagination is stable across pages
...
AS $$
  ...
  ORDER BY ls.created_at DESC, ls.template_id  -- Added template_id for stable paging
  LIMIT p_limit
  OFFSET p_offset;
$$;
