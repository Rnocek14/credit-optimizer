-- Add processing_by_institution to health check
...
BEGIN
  ...
  -- Build processing_by_institution (active work)
  SELECT COALESCE(
    jsonb_object_agg(institution_code, cnt),
    '{}'::jsonb
  ) INTO processing_by_inst
  FROM (
    SELECT 
      pc.institution_code,
      COUNT(*)::int as cnt
  ...
  SELECT jsonb_build_object(
    ...
    'processing_by_institution', processing_by_inst,
