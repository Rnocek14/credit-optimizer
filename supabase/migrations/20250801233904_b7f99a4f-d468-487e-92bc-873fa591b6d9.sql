-- Populate missing test data for Phase 4 validation
...
-- Create user progress entries for CRI calculation
INSERT INTO public.user_progress (user_id, item_id, item_type, status, completion_percentage, cri_score) 
VALUES 
  ('00000000-0000-0000-0000-000000000001', gen_random_uuid(), 'skill', 'completed', 100, 82),
  ('00000000-0000-0000-0000-000000000001', gen_random_uuid(), 'skill', 'completed', 100, 78),
  ('00000000-0000-0000-0000-000000000001', gen_random_uuid(), 'skill', 'in_progress', 65, 70),
  ('00000000-0000-0000-0000-000000000001', gen_random_uuid(), 'step', 'completed', 100, 85),
  ('00000000-0000-0000-0000-000000000001', gen_random_uuid(), 'step', 'in_progress', 40, 72)
...
-- Create market trend data for validation
INSERT INTO public.market_trends (career_path, location, trend_score, data_source, period_start, period_end, insights)
SELECT 
  'Data Scientist',
  'San Francisco',
  8.7,
  ...
  now(),
  '{"salary_trend": "increasing", "demand_growth": 15.2, "skill_gaps": ["machine_learning", "deep_learning"]}'::jsonb
WHERE NOT EXISTS (
  SELECT 1 FROM public.market_trends 
  WHERE career_path = 'Data Scientist' AND location = 'San Francisco'
)
UNION ALL
SELECT 
  ...
  now() - interval '1 month',
  now(),
  '{"salary_trend": "strong_growth", "demand_growth": 22.8, "skill_gaps": ["mlops", "tensorflow"]}'::jsonb
WHERE NOT EXISTS (
  SELECT 1 FROM public.market_trends 
  WHERE career_path = 'Machine Learning Engineer' AND location = 'San Francisco'
);
