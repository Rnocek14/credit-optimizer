-- Sprint 0: Schema & Auth Debug Fixes
...
-- 2) Fix user_preferences FK constraint
ALTER TABLE public.user_preferences
  DROP CONSTRAINT IF EXISTS user_preferences_user_id_fkey;

-- Ensure user_id is proper UUID type and NOT NULL
ALTER TABLE public.user_preferences
...
-- 4) Fix user_preferences RLS policies
