...
-- Fix demo users for gallery display
-- 1. Update Aisha Khan's profile to have proper gallery settings
...
-- 2. Create profile for Mateo Silva
INSERT INTO public.profiles (
  ...
  resume_review_summary = EXCLUDED.resume_review_summary,
  updated_at = now();

-- 3. Create profile for Jade Chen
INSERT INTO public.profiles (
  user_id, name, role_title, location, industry, years_experience, experience_level,
  skills, gallery_enabled, gallery_featured,
  resume_review_summary, created_at, updated_at
...
-- 4. Create/update resume drafts for all demo users
INSERT INTO public.ai_resume_drafts (
  user_id, title, content, published_to_profile, cri_average, readiness_score, created_at, updated_at
) VALUES 
-- Aisha Khan's resume
(
  ...
  '{
    "summary": "Experienced full-stack software engineer with 5+ years of experience building scalable web applications using React, Node.js, and cloud technologies. Proven track record of leading development teams and delivering high-quality products in fast-paced environments.",
    "bullets": [
      "Led development of React-based dashboard serving 10k+ daily active users",
      ...
      "Built real-time chat system handling 1M+ messages daily using WebSocket"
    ],
    "skills": {
...
(
  ...
  '{
    "summary": "Strategic product manager with 4+ years of experience driving product growth through data-driven insights and user-centric design. Successfully launched 5+ products resulting in $2M+ ARR and 50% user engagement increase.",
    "bullets": [
      "Launched mobile app feature increasing user retention by 35%",
      "Led cross-functional team of 8 engineers and designers",
      "Conducted 50+ user interviews to inform product roadmap decisions",
      "Implemented A/B testing framework improving conversion rates by 25%",
      "Developed go-to-market strategy for B2B SaaS product launch"
    ],
    "skills": {
      "Product Strategy": ["Roadmapping", "Market Research", "Competitive Analysis"],
      "Analytics": ["SQL", "Mixpanel", "Google Analytics", "A/B Testing"],
      "Design": ["Figma", "User Research", "Wireframing", "Prototyping"],
      "Business": ["Stakeholder Management", "Agile", "Scrum", "OKRs"]
    }
  }',
  true,
  7.8,
...
(
  ...
  'UX Designer Resume',
  '{
    "summary": "Creative UX designer with 3+ years of experience crafting intuitive digital experiences. Specialized in user research, interaction design, and design systems. Successfully redesigned 10+ digital products improving user satisfaction scores by 40%.",
    "bullets": [
      "Redesigned e-commerce checkout flow increasing conversion rate by 28%",
      "Conducted usability testing with 100+ participants across 5 product iterations",
      "Created comprehensive design system adopted by 3 product teams",
      "Led user research initiatives resulting in 2 major product pivots",
    ...
    "skills": {
      ...
      "Prototyping": ["Interactive Prototypes", "Wireframing", "Design Systems"],
      "Collaboration": ["Cross-functional Teams", "Design Handoff", "Stakeholder Presentations"]
    }
  }',
  true,
  8.0,
...
-- 5. Ensure demo users have some XP and badges for completeness
INSERT INTO public.user_xp (user_id, total_xp) VALUES
  ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 250),
  ('3c459625-e499-5ddb-b64d-a442dd21f474'::uuid, 180),
  ('4d56a736-f5aa-6eec-c75e-b553ee32e585'::uuid, 220)
ON CONFLICT (user_id) 
DO UPDATE SET 
