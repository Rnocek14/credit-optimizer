-- First, let's check what valid types exist and then add meaningful skill prerequisites
-- Using 'pivot', 'branch', 'backtrack' as valid types based on existing schema
