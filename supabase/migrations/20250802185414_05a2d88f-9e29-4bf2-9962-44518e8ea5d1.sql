-- Phase 5 Enhancement: Additional Market Intelligence Data and Enhanced Scenarios (Corrected)
...
-- Insert enhanced Maya decisions with correct schema
INSERT INTO public.maya_decisions (
  user_id, decision_type, decision_context, decision_rationale, confidence_score
) VALUES 
  ('00000000-0000-0000-0000-000000000001', 'career_pivot', 
   '{"current_role": "Senior Data Scientist", "target_role": "AI Engineer", "skill_overlap": 0.75, "market_timing": "optimal", "transition_options": ["gradual", "accelerated", "hybrid"]}',
  ...
  ('00000000-0000-0000-0000-000000000001', 'learning_optimization', 
   '{"goal": "Cloud Architecture Mastery", "current_level": "intermediate", "target_certification": "AWS Solutions Architect Professional", "market_demand": "high"}',
  ...
  ('00000000-0000-0000-0000-000000000001', 'market_timing', 
   '{"target_role": "Senior Full Stack Developer", "location": "Remote", "market_cycle": "growth_phase", "hiring_trends": "increasing"}',
