-- Drop existing policies that conflict and create the new block-based tables
DROP POLICY IF EXISTS "Service role can manage education courses" ON public.edu_courses;
DROP POLICY IF EXISTS "Public read access to education courses" ON public.edu_courses;
