-- Just add the sample data that's missing, using the correct table structure
INSERT INTO public.profiles (user_id, name, role) VALUES 
('2b458624-d498-4cca-a63d-9341cc20e363', 'Aisha Khan', 'mentor'),
('3c459625-e499-5ddb-b64d-a442dd21f474', 'Mateo Silva', 'mentor'),
('4d56a736-f5aa-6eec-c75e-b553ee32e585', 'Jade Chen', 'admin')
