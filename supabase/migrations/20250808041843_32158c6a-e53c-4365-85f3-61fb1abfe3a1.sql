-- Course Intelligence & Educator Reputation Engine - Phase 1
-- Comprehensive database schema for Course Intelligence Graph + Difficulty Engine + CRI Enhancement

-- ===== CORE COURSE INTELLIGENCE TABLES =====

-- Enhanced normalized course master table
...
-- Verified instructor profiles with prestige tracking
...
-- AI + user feedback difficulty ratings (normalized 1-5 scale)
...
-- Standardized skill-to-course mappings
...
-- Multi-category instructor assessments
...
-- Enhanced CRI scores with detailed breakdowns
