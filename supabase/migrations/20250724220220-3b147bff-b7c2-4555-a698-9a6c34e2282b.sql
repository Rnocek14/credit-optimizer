-- Phase 2.1: Create unified career_graph_nodes table (without vector embeddings)
CREATE TABLE IF NOT EXISTS public.career_graph_nodes (
  ...
  -- Semantic AI fields (no vector for now)
  semantic_tags TEXT[],
...
-- Migrate existing data into unified nodes table
-- Migrate skills
