-- Create seed data for testing Aisha Khan's mentor analytics
...
-- Insert course intelligence pipeline entries for Aisha Khan (using string UUID for validated_by)
...
INSERT INTO public.mentor_achievements (id, mentor_id, achievement_type, achievement_name, description, badge_emoji, points_awarded, created_at)
VALUES 
