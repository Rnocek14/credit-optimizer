-- Create additional Maya decisions with correct column names including decision_rationale
INSERT INTO public.maya_decisions (user_id, decision_type, confidence_score, decision_context, decision_rationale)
VALUES 
  ('2b458624-d498-4cca-a63d-9341cc20e363', 'career_pivot_recommendation', 0.92, 
   ...
   'Based on user''s strong analytical background and current Python expertise, transitioning to senior data scientist role offers optimal career growth'),
  ('2b458624-d498-4cca-a63d-9341cc20e363', 'skill_gap_analysis', 0.88, 
   ...
   'Analysis shows need for advanced ML skills and cloud architecture knowledge to reach senior level'),
  ('2b458624-d498-4cca-a63d-9341cc20e363', 'learning_optimization', 0.95, 
   ...
   'Optimized learning schedule based on user availability and retention patterns'),
  ('3c459625-e499-5ddb-b64d-a442dd21f474', 'market_opportunity_alert', 0.85, 
   ...
   'Significant market growth detected in remote frontend development opportunities'),
  ('3c459625-e499-5ddb-b64d-a442dd21f474', 'learning_path_optimization', 0.91, 
   ...
   'Optimal path from React specialization to full-stack development identified'),
  ('3c459625-e499-5ddb-b64d-a442dd21f474', 'certification_priority', 0.89, 
   ...
   'AWS Cloud Practitioner certification provides highest ROI for current skill set'),
  ('4d56a736-f5aa-6eec-c75e-b553ee32e585', 'certification_recommendation', 0.89, 
   ...
   'AWS Solutions Architect certification aligns with career goals and market demand'),
  ('4d56a736-f5aa-6eec-c75e-b553ee32e585', 'salary_negotiation_insights', 0.87, 
   ...
   'Market analysis indicates strong negotiation position based on cloud expertise'),
  ('4d56a736-f5aa-6eec-c75e-b553ee32e585', 'career_acceleration', 0.93, 
   ...
   'Technical leadership track identified as optimal acceleration path')
