...
VALUES 
    ...
    ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 'Kubernetes Certification', 'CKA certification preparation course', 'Linux Foundation', 'https://training.linuxfoundation.org', '$300', 'Advanced', ARRAY['Kubernetes', 'DevOps'], 'Industry standard container orchestration', true),
    ...
    ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 'Deep Learning Specialization', 'Comprehensive neural networks course', 'Coursera', 'https://coursera.org/deeplearning', '$49/month', 'Advanced', ARRAY['Deep Learning', 'AI'], 'Industry-leading ML course', true),
    ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 'MLOps with Kubeflow', 'Production machine learning pipelines', 'Google Cloud', 'https://cloud.google.com/training', '$200', 'Advanced', ARRAY['MLOps', 'Kubernetes'], 'Production ML systems', true),
    ('2b458624-d498-4cca-a63d-9341cc20e363'::uuid, 'Computer Vision with PyTorch', 'Advanced computer vision techniques', 'Fast.ai', 'https://fast.ai', 'Free', 'Advanced', ARRAY['Computer Vision', 'PyTorch'], 'Practical deep learning', true);