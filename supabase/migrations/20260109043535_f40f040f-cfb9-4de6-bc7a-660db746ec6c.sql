-- Fix regressions: restore canonical paths + per-field provenance validation
...
BEGIN
  ...
  IF TG_OP = 'UPDATE' AND OLD.status = 'active' THEN
    ...
    -- Parse OLD values with full validation (handles legacy bad data)
    ...
    -- Parse NEW values with same validation
  ...
  -- ══════════════════════════════════════════════════════════════════
  -- GATE 1: Per-field provenance keys must exist
  -- ══════════════════════════════════════════════════════════════════
  ...
  -- ══════════════════════════════════════════════════════════════════
  -- GATE 2: Per-field provenance sources must be ground_truth or human_override
  -- ══════════════════════════════════════════════════════════════════
