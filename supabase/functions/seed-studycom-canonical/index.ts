...
Deno.serve(async (req) => {
  ...
  if (roleError || userRole !== "admin") {
    console.warn(`[seed-studycom-canonical] SECURITY: Non-admin user blocked`, {
      userId: user.id,
      email: user.email,
      role: userRole,
  ...
  console.log(`[seed-studycom-canonical] Admin ${user.email} authorized for canonical seeding`);
